...
if (existsSync(memoryGlob)) {
  ...
  for (const dir of projectDirs) {
    ...
    if (existsSync(memPath)) {
      ...
      alwaysLoaded.push({ file: `~/.claude/projects/${dir}/memory/MEMORY.md`, tokens: countTokens(content), reason: 'auto-memory, loaded every session' });
    }
  }
}
...
// Realistic target: reduce always-loaded by converting non-disabled skills + pruning
