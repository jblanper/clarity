...
export default function BottomNav() {
  ...
  // Hide the nav on Settings, Manage, Edit, and Help pages — those have their own back navigation
  if (pathname === "/settings" || pathname === "/manage" || pathname === "/edit" || pathname === "/help") {
    return null;
  }
